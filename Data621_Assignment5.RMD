...
```{r}
missmap(wine_train, main = "Missing values vs observed",  color='dodgerblue')
```

Form the above plot we can see that most of the missing values are for STARS variable. 
